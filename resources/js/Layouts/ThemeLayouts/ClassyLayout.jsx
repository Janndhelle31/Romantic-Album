...
const couplePolaroids = [
    { id: 1, src: "https://images.unsplash.com/photo-1516589174184-c685265142ec?w=500", top: "5%", left: "4%", rotate: -8, duration: 20 },
    { id: 2, src: "https://images.unsplash.com/photo-1522673607200-164883efeca1?w=500", top: "10%", left: "75%", rotate: 6, duration: 24 },
    { id: 3, src: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=500", top: "65%", left: "2%", rotate: 10, duration: 22 },
    { id: 4, src: "https://images.unsplash.com/photo-1529634806980-85c3dd6d34ac?w=500", top: "70%", left: "78%", rotate: -5, duration: 26 },
];
...
export default function ClassyLayout({ 
    ...
    return (
        <div className="font-serif bg-[#FAF9F6] text-[#1A1A1A] antialiased selection:bg-[#E5D3B3] min-h-screen relative overflow-x-hidden">
                ...
                <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden" style={{ contain: 'layout paint' }}>
                    {couplePolaroids.map((p) => (
                        <motion.div
                            ...
                            className="absolute w-48 md:w-72 bg-white p-3 pb-14 shadow-xl border border-gray-100/50 transform-gpu will-change-transform"
                            style={{ top: p.top, left: p.left, rotate: p.rotate }}
                        >
                            <div className="w-full h-full bg-gray-50 overflow-hidden sepia-[0.2] contrast-[0.9]">
            ...
            {/* Note: Duplicated ClassyHearts component removed here. It is handled by AppLayout. */}
                    ...
                    {!isEntryClicked && (
                        ...
                        >
                            <div className="relative group p-20">
                                ...
                                <motion.span initial={{ opacity: 0, letterSpacing: "0.8em" }} animate={{ opacity: 1, letterSpacing: "0.5em" }} className="block mb-8 text-[10px] uppercase font-light text-[#A68966]">
                                    A Private Collection
                                </motion.span>
                                
                                <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="text-6xl md:text-8xl font-light italic mb-12 tracking-tighter">
                                    Two Souls, One Story
                                </motion.h1>
